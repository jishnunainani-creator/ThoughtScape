  ...
  const toolsList = [
    {
      ...
      example: '"Create a concept map for Biology Human Circulatory System."',
      badge: 'High-Level',
    },
    {
      name: 'get_workspace',
      desc: 'Fetches the complete active Thoughtscape state (notes, clusters, connections).',
      example: '"What thoughts do I currently have on my landscape?"',
      badge: 'Read',
    },
    {
      name: 'search_thoughts',
      desc: 'Searches across titles, markdown content, tags, and colors.',
      example: '"Find all thoughts about science revision or upcoming exams."',
      badge: 'Read',
    },
    {
      name: 'create_thought',
      desc: 'Creates a single sticky note with auto-placement near related concepts.',
      example: '"Add a thought about Physics Ohm\'s law with formula details."',
      badge: 'Write',
    },
    {
      name: 'create_cluster',
      desc: 'Creates a conceptual section container to group related thoughts visually.',
      example: '"Group my study notes into a Science Revision cluster."',
      badge: 'Write',
    },
    {
      name: 'create_connection',
      desc: 'Draws a relationship arrow or connector between two thoughts.',
      example: '"Connect Science Revision to Board Exam Plan with label steps."',
      badge: 'Relationships',
    },
    {
      name: 'suggest_connections',
      desc: 'Analyzes thoughts and returns AI-suggested semantic links without auto-applying.',
      example: '"What connections can I make between my project and meeting notes?"',
      badge: 'AI Analysis',
    },
    {
      name: 'get_landscapes',
